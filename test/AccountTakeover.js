...
it("AccountTakeover", async function () {
  ...
  console.log(
    "This challenge basically relies on the fact that in one of the txns"
  );
  console.log("Same value of 'r' was used");

  console.log(
    "Get all transactions of the account and match r, first two txns made by the account!"
  );
  ...
  console.log(
    "ref: https://bitcoin.stackexchange.com/questions/37760/converting-ruby-script-into-python-recovering-private-key-when-someone-uses-th/37762#37762"
  );
